...
## exemple: (llenv) mauceric@sanroque:~/lora_local$ python merge_and_quantize.py --base gguf_out.précieux/phi4_merged/merged_hf/ --lora test_wikipedia/ --out test_wikipedia_merged/ --gguf-dir test_wikipedia_gguf/ --llama-cpp ../llama.cpp/ --quantize-types Q4_K_M Q5_K_M Q6_K
