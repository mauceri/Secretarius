#!/usr/bin/env python3
"""
Étape 3 — Comparaison RAG classique vs indexation par expressions.
...
Protocole :
  ...
  - Requête : une question synthétique par chunk, générée par DeepSeek
...
Usage :
    ...
    python eval_rag_vs_expressions.py [--n 200] [--out eval_rag_results.json]
"""
...
def main() -> None:
    ...
    parser.add_argument("--query-exprs-cache",    default="eval_rag_query_exprs.json")
    parser.add_argument("--out",                  default="eval_rag_results.json")
