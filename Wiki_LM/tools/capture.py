...
RAW_DEFAULT = Path(os.environ.get("WIKI_PATH", str(Path.home() / "Documents" / "Secretarius" / "Wiki_LM"))).expanduser() / "raw"
_DEFAULT_KB_DIR = Path(os.environ.get("WIKI_PATH", str(Path.home() / "Documents" / "Secretarius" / "Wiki_LM"))).expanduser() / "knowledge_base"
